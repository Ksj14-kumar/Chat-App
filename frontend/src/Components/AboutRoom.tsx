...
function AboutRoom({ setDisplayRoomSetting, admin,height }: propType) {
    return (
        <motion.div
            ...
            className={`tool_tips absolute z-[999]  ${height>=15?"mobile:h-[55%] h-[75%]":"mobile:h-[90%] h-[87%]"} right-4 rounded-md w-[10rem] top-2 overflow-hidden flex flex-col bg-gradient-to-r from-gray-400 via-gray-600 to-blue-800 pb-3`}>
